-- Seed workflows and reusable attack-pattern playbook entries
...
-- ============ ATTACK PATTERN PLAYBOOK ============

INSERT INTO attack_patterns (pattern_name, description, target_types, times_used, times_hit, avg_severity, last_used) VALUES
('assumption-mining', 'Extract every assumption from artifact and verify if testable/verified', 'spec,plan,design', 2, 1, 4.0, '2026-02-12 01:34:00'),
('temporal-breakage', 'Identify things that work today but will break due to time, ordering, or growth', 'plan,design,implementation', 2, 1, 3.0, '2026-02-12 01:34:10'),
('integration-boundary-gaps', 'Examine where two systems meet and find unhandled edge cases', 'integration,plan', 2, 1, 3.0, '2026-02-12 01:34:21'),
('unbounded-growth-silent', 'Find data stores that grow without bounds and have no pruning/archival strategy', 'plan,architecture', 2, 1, 3.0, '2026-02-12 01:34:34'),
('bootstrap-paradox', 'Find circular dependencies in initialization where A needs B but B needs A', 'plan,architecture', 2, 1, 4.0, '2026-02-12 01:34:46'),
('reality-check-deps', 'Verify claimed dependencies actually exist in the codebase', 'plan', 2, 1, 2.0, '2026-02-12 01:35:04');