...
- include: `automation-self-improvement/agentops/tests/**/*.test.ts`, `demo/**/*.ts`, `src/**/__tests__/**/*.test.ts`
- exclude: `automation-self-improvement/agentops/tests/integration.test.ts`, `automation-self-improvement/agentops/tests/phase1.2.test.ts`
...
| --- | --- | --- | --- | --- |
| automation_agentops_suite | automation-self-improvement/agentops/tests/cross-layer-sources.test.ts | yes | no | agentops, integration, proposal, workflow |
| automation_agentops_suite | automation-self-improvement/agentops/tests/extract.test.ts | yes | no | agentops, integration, proposal, workflow |
| automation_agentops_suite | automation-self-improvement/agentops/tests/integration.test.ts | no | no | agentops, integration, proposal, workflow |
| automation_agentops_suite | automation-self-improvement/agentops/tests/phase1.2.test.ts | no | no | agentops, integration, proposal, workflow |
| automation_agentops_suite | automation-self-improvement/agentops/tests/sources.test.ts | yes | no | agentops, integration, proposal, workflow |
| automation_agentops_suite | automation-self-improvement/agentops/tests/synthesis.test.ts | yes | no | agentops, integration, proposal, workflow |
