<!--
    ...
    - run_2026-03-26T02-59-36-571Z_ihb9g8                unique id
    - thoughtbox_daily_proposals              e.g. thoughtbox_daily_proposals
    - 0.1.0           e.g. 0.1.0
    - dry-run-sha               repo SHA scanned
    - main              e.g. main
    - https://smith.langchain.com/o/your-org/projects/p/thoughtbox/r/run_2026-03-26T02-59-36-571Z_ihb9g8             LangSmith trace/experiment link (optional but recommended)
...
---
  ...
  "proposals": [
    ...
    **Run:** `run_2026-03-26T02-59-36-571Z_ihb9g8`  
    **Job:** `thoughtbox_daily_proposals@0.1.0`  
    **Repo ref:** `main` @ `dry-run-sha`  
    **Budgets:** max_cost=$10, max_minutes=30  
    **Trace:** https://smith.langchain.com/o/your-org/projects/p/thoughtbox/r/run_2026-03-26T02-59-36-571Z_ihb9g8  
...
---
    ...
    <!-- AGENTOPS_META_BEGIN
    {
      "run_id": "run_2026-03-26T02-59-36-571Z_ihb9g8",
