...
NOTE FROM ALEPH: I wasn't able to get the agent sessions into the submission: got a FUNCTION_PAYLOAD_TOO_LARGE error when I tried. Happy to send them over via email if requested.